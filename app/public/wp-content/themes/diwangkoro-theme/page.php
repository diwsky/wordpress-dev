<?php
    ...
    <?php
        ...
        <div class="metabox metabox--position-up metabox--with-home-link">
            <p>
                <a class="metabox__blog-home-link" href="<?php echo the_permalink($parentID)?>">
    ...
    <?php 
        ...
        $arrPages = get_pages(array(
            'child_of' => get_the_ID()
        ));

        if ($parentID or $arrPages) {
                ...
                <ul class="min-list">
                    <?php 
                        ...
                        if ($parentID) {
                            ...
                            // if user is in the parent page (don't have parent ID)
